    ...
    public void onStartTag(XmlNodeStartTag xmlNodeStartTag) {
        ...
        switch (xmlNodeStartTag.getName()) {
            ...
            case "meta-data":
                ...
                metaData.setName(attributes.get("name"));
                metaData.setValue(attributes.get("value"));
                apkMeta.addMetaData(metaData);
                break;
            case "activity":
                apkMeta.addActivity(attributes.get("name"));
                break;
            case "service":
                apkMeta.addService(attributes.get("name"));
                break;
            case "receiver":
                apkMeta.addReceiver(attributes.get("name"));
                break;
            case "provider":
                apkMeta.addProvider(attributes.get("name"));
                break;
        }
